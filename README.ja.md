...
| `L12` | 清潔で均一な商業用ソフトライト |
| `L13` | 距離減衰の速い蝋燭／炎の近接キーライト |
| `L14` | 控えめな正面フィルを伴うリム主導のドラマ光 |
...
| 効果 | レシピ |
| --- | --- |
| プリズムグロー | `L1/L4 + E2 + Sx + P2 + T1 + G1 + D1 + A7` |
| ブラインドの縞影 | `L6 + E5 + Sx + P3 + T1/T2 + G1/G4 + D1 + A8` |
| 蝋燭のローキー | `L13 + E5 + Sx + P6 + T8 + G3/G4 + D1 + A0/A3` |
| ネオン都市光 | `L11 + E5 + Sx + P6 + T4 + G4 + D1 + A3/A9` |
| 金色の薄暮 | `L10 + E2 + Sx + P2 + T2 + G0/G1 + D0/D1 + A4` |
| 柔らかな朝の窓光 | `L2 + E1 + Sx + P2 + T1/T2 + G0/G1 + D0/D2 + A0/A1` |
| リム主導のドラマ光 | `L14 + E2/E5 + Sx + P3 + T2/T3 + G1/G4 + D1 + A0/A5` |
| 寒色の雨夜ローキー | `L4/L11 + E5 + Sx + P6 + T5/T4 + G3/G4 + D1 + A9` |
